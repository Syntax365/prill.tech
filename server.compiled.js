...
function getDailyFactS3Data(_x2, _x3) {
  return _getDailyFactS3Data.apply(this, arguments);
} ///////////////////////////////////////////////////////


function _getDailyFactS3Data() {
  _getDailyFactS3Data = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(req, res) {
    var data;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return s3Exports.getDailyFact(req);
